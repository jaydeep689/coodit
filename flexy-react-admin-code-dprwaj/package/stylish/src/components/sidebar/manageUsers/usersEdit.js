...
import { Avatar, Card, Grid, Typography, Button, Autocomplete } from '@material-ui/core';
...
const UsersEdit = () => (
    <PageContainer title="Manage Users Edit" description="this is Manage Users Edit page">
        <Breadcrumb title="Manage Users Edit page" subtitle="Users" />
            ...
            <Grid item lg={8} md={12} xs={12}>
                <Card variant="outlined" sx={{ p: 3 }}>
                    ...
                    <form>
                        ...
                        <CustomFormLabel>ApprovedBy</CustomFormLabel>
